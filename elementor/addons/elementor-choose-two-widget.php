...
namespace Elementor;
class Softim_Choose_Two_Widget extends Widget_Base
{
    ...
    {
        return 'softim-choose-two-widget';
    }
    ...
    {
        return esc_html__('Choose : 02', 'softim-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'title', [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__("Experience Your Product As You Create It.", 'softim-core'),
                    ...
                    <div class="row justify-content-center mb-30-none">
                        <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 mb-30">
                            <div class="project-item-two">
                                <div class="project-content">
                                    <h2 class="title">
                                        <a href="<?php echo esc_url($settings['project1_link']['url']); ?>"><?php echo esc_html($settings['project1_text']); ?></a>
                                    </h2>
                                    <p><?php echo esc_html($settings['project1_info']); ?></p>
                                </div>
                                <div class="project-thumb">
                                    <img src="<?php echo esc_html($settings['project1_image']['url']); ?>"
                                         alt="element">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 mb-30">
                            <div class="project-item-two style">
                                <div class="project-thumb">
                                    <img src="<?php echo esc_html($settings['project2_image']['url']); ?>"
                                         alt="element">
                                </div>
                                <div class="project-content">
                                    <h2 class="title">
                                        <a href="<?php echo esc_url($settings['project2_link']['url']); ?>"><?php echo esc_html($settings['project2_text']); ?></a>
                                    </h2>
                                    <p><?php echo esc_html($settings['project2_info']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                    <div class="service-item two five">
                                        ...
                                        <div class="service-content">
                                            <h3 class="title"><?php echo esc_html($item['service_title']); ?></h3>
...
Plugin::instance()->widgets_manager->register(new Softim_Choose_Two_Widget());