...
namespace Elementor;
class Softim_Development_One_Widget extends Widget_Base
{
    ...
    {
        return 'softim-development-one-widget';
    }
    ...
    {
        return esc_html__('Development : 01', 'softim-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'settings_section',
            [
                'label' => esc_html__('Development Left', 'softim-core'),
        ...
        $this->add_control(
            'image1', [
                ...
                'show_label' => false,
                'description' => esc_html__('development grid image', 'softim-core'),
                'default' => [
        ...
        $this->add_control(
            'image2', [
                'label' => esc_html__('Move Grid Image 2', 'softim-core'),
                'type' => Controls_Manager::MEDIA,
                'show_label' => false,
                'description' => esc_html__('development grid image', 'softim-core'),
                'default' => [
        ...
        $this->add_control(
            'image3', [
                'label' => esc_html__('Development Thumbnail Image', 'softim-core'),
                'type' => Controls_Manager::MEDIA,
                'show_label' => false,
                'description' => esc_html__('development Thumbnail image', 'softim-core'),
                'default' => [
                    'src' => Utils::get_placeholder_image_src()
                ],
            ]
...
//      Development Right Section
        $this->start_controls_section(
            'develop_right',
            [
                'label' => esc_html__('Development Right', 'softim-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
            'title', [
                ...
                'default' => esc_html__("The Expert in Web Development Company", 'softim-core'),
...
//      Development List Loop
        $this->start_controls_section(
            'develop_list_item',
            [
                'label' => esc_html__('Development Right List', 'softim-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'list_item', [
                'label' => esc_html__('List Item', 'softim-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Bringing new IT solutions to the market', 'softim-core'),
                'description' => esc_html__('enter list item', 'softim-core'),
            ]
        );

        $this->add_control('develop_list', [
                        ...
                        <div class="content">
                            ...
                            <div class="more-btn">
                                <?php if ($settings['btn_status'] == 'yes'): ?>
                                    <a href="<?php echo esc_url($settings['btn_link']['url']); ?>"><?php echo esc_html($settings['btn_text']); ?></a>
                                    <div class="icon">
...
Plugin::instance()->widgets_manager->register(new Softim_Development_One_Widget());