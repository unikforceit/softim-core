    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single-testimonial-item-02',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    "{{WRAPPER}} .single-testimonial-item-02 .content p" => 'margin-bottom: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    "{{WRAPPER}} .single-testimonial-item-02 .ratings i+i" => 'margin-left: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    "{{WRAPPER}} .single-testimonial-item-02 .author-meta" => 'padding: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        $this->add_control('icon_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-testimonial-item-02 .content .icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('name_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-testimonial-item-02 .author-meta .title" => "color: {{VALUE}}"
            ]
        ]);
        ...
        $this->add_control('rating_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-testimonial-item-02 .ratings i" => "color: {{VALUE}}"
            ]
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            "selector" => "{{WRAPPER}} .single-testimonial-item-02 .author-meta .title"
        ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [
...
Plugin::instance()->widgets_manager->register_widget_type(new Softim_Testimonial_Two_Widget());
