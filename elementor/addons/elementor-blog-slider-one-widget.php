...
namespace Elementor;
class Softim_Blog_Post_Slider_One_Widget extends Widget_Base
{
    ...
    {
        return esc_html__('Blog: Slider 01', 'softim-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Softim_Blog_Post_Slider_One_Widget());