...
namespace Elementor;
class Softim_Packages_Single_Slider_Two_Widget extends Widget_Base
{
    ...
    {
        return 'softim-packages-single-slider-two-widget';
    }
    ...
    {
        return esc_html__('Packages Single Slider: 02', 'softim-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Video Settings', 'softim-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('dots Settings', 'softim-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
                            ...
                            <div class="content">
                                ...
                                <div class="btn-wrap">
                                    ...
                                    <a href="<?php echo esc_url($packages_single_meta_data['packages_video_link']) ?>"
                                       class="button-video mfp-iframe"><?php echo softim_core()->render_elementor_icons($settings['icon']) ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Softim_Packages_Single_Slider_Two_Widget());