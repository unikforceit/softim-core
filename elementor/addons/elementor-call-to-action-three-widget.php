...
namespace Elementor;
class Softim_Call_To_Action_Three_Widget extends Widget_Base
{
    ...
    {
        return 'softim-call-to-action-three-widget';
    }
    ...
    {
        return esc_html__('Call To Action : 03', 'softim-core');
    }
...
Plugin::instance()->widgets_manager->register(new Softim_Call_To_Action_Three_Widget());