...
namespace Elementor;
class Softim_Price_One_Widget extends Widget_Base
{
    ...
    {
        return 'softim-price-one-widget';
    }
    ...
    {
        return esc_html__('Price : 01', 'softim-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'item_bg',
            [
                'label' => esc_html__('Price item background', 'softim-core'),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'two' => esc_html__('No background', 'softim-core'),
                    'three' => esc_html__('Background', 'softim-core')
                ),
                'description' => esc_html__('select item background', 'softim-core'),
                'default' => '6'
            ]
        );
...
//      Yearly Tab Loop
    ...
    protected function render()
    {
        ...
        <section class="plan-section <?php echo esc_attr($settings['item_bg']); ?> ptb-120">
            <div class="container">
...
Plugin::instance()->widgets_manager->register(new Softim_Price_One_Widget());