...
namespace Elementor;
class Softim_Service_Three_Widget extends Widget_Base
{
    ...
    {
        return 'softim-service-three-widget';
    }
    ...
    {
        return esc_html__('Service: 03', 'softim-core');
    }
                                    ...
                                    <div class="service-content">
                                        ...
                                        <div class="service-btn">
                                            <a href="<?php the_permalink(); ?>"
                                               class="custom-btn"><?php echo esc_html('Learn More') ?> <i
                                                        class="icon-Group-2361 ml-2"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
...
Plugin::instance()->widgets_manager->register(new Softim_Service_Three_Widget());