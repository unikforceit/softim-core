...
namespace Elementor;
class Softim_Deals_Single_Slider_Widget extends Widget_Base
{
    ...
    {
        return 'softim-deals-single-slider-widget';
    }
    ...
    {
        return esc_html__('Deals Single Slider', 'softim-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'deals_system',
            [
                'label' => esc_html__('Deals Style System', 'softim-core'),
        ...
        $this->add_control('category', [
            ...
            'multiple' => true,
            'options' => softim()->get_terms_names('deals-cat', 'id'),
        ...
        $this->add_control('normal_background_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-deals-box .content" => "background-color: {{VALUE}};"
            ]
        ]);
        $this->add_group_control(
            ...
            [
                'name' => 'border',
                'label' => esc_html__('Box Border', 'softim-core'),
                'selector' => '{{WRAPPER}} .single-deals-box',
            ]
        );
        $this->add_control('normal_title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box .content .title" => "color: {{VALUE}};"
            ]
        ]);
        $this->add_control('normal_description_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box .content p" => "color: {{VALUE}};"
            ]
        ]);
        $this->add_control('normal_meta_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box .content .package-list li" => "color: {{VALUE}};"
            ]
        ]);
        $this->add_control('meta_border_color', [
            'label' => esc_html__('Meta Border Color', 'softim-core'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box .content .package-list" => "border-color: {{VALUE}};"
            ]
        ]);
        ...
        $this->add_control('hover_title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box:hover .content .title" => "color: {{VALUE}};"
            ]
        ]);
        $this->add_control('hover_description_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .single-deals-box:hover .content p" => "color: {{VALUE}};"
            ]
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .single-deals-box .content .title"
        ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => "{{WRAPPER}} .single-deals-box .content p"
        ]);
    ...
    protected function render()
    {
        ...
        <div class="deals-carousel-one-wrapper">
            <div class="deals-wrapper testimonial-carousel"
                 id="softim-deals-wrapper-<?php echo esc_attr($rand_numb); ?>"
                ...
                while ($post_data->have_posts()) : $post_data->the_post();
                    ...
                    $deals_single_meta_data = get_post_meta(get_the_ID(), 'softim_deals_options', true);
                    ?>
                    <div class="deals-outer-wrap">
                        <div class="single-deals-box bg-image">
                            <div class="thumb">
                            ...
                            <div class="content">
                                ...
                                <p> <?php echo $deals_single_meta_data['deals_jet_models_option'] ?></p>
                                <ul class="package-list">
                                    <li><?php echo $deals_single_meta_data['deals_jet_seats_option'] ?></li>
                                    <li><?php echo esc_html__('Price:', 'softim-core') ?> <?php echo $deals_single_meta_data['deals_price_option'] ?></li>
                                </ul>
                                <div class="btn-wrap">
                                    <a href="<?php the_permalink() ?>"
                                       class="blank-btn"><i class="flaticon-black-plane"></i><?php echo esc_html__('Book Now', 'softim-core'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                while ($post_data->have_posts()) : $post_data->the_post();
                    ...
                    <div class="col-lg-<?php echo esc_attr($settings['column']); ?> col-md-6">
                        <div class="single-deals-box bg-image margin-bottom-30">
                            <div class="thumb">
                                <img src="<?php echo esc_url($img_url) ?>" alt="<?php echo $img_alt ?>">
                            </div>
                            <div class="content">
...
Plugin::instance()->widgets_manager->register_widget_type(new Softim_Deals_Single_Slider_Widget());