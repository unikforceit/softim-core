...
namespace Elementor;
class Softim_Project_Two_Widget extends Widget_Base
{
    ...
    {
        return 'softim-project-two-widget';
    }
    ...
    {
        return esc_html__('Project: 02', 'softim-core');
    }
...
Plugin::instance()->widgets_manager->register(new Softim_Project_Two_Widget());