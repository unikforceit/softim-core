...
namespace Elementor;
class Softim_Service_Four_Widget extends Widget_Base
{
    ...
    {
        return 'softim-service-four-widget';
    }
    ...
    {
        return esc_html__('Service: 04', 'softim-core');
    }
...
Plugin::instance()->widgets_manager->register(new Softim_Service_Four_Widget());