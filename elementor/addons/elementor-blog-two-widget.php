...
namespace Elementor;
class Softim_Blog_Post_Two_Widget extends Widget_Base
{
    ...
    {
        return esc_html__('Blog: 02', 'softim-core');
    }
...
Plugin::instance()->widgets_manager->register(new Softim_Blog_Post_Two_Widget());