...
class Customizer {
	...
	public function add_sections( $wp_customize ) {
		...
		$wp_customize->add_section(
			$section_name,
			[
				'title'    => esc_html__( 'Variation Swatches', 'softim-variation-swatches' ),
				'description' => esc_html__( 'Some of these options can be overidden in product data settings.', 'softim-variation-swatches' ),
				'priority' => 30,
				'panel'    => 'woocommerce',
			]
		);
		...
		$wp_customize->add_control(
			new Size_Control(
				...
				$this->settings_api->get_option_name( 'size' ),
				[
					'label'       => esc_html__( 'Swatches Size', 'softim-variation-swatches' ),
		...
		$wp_customize->add_control(
			$this->settings_api->get_option_name( 'tooltip' ),
			[
				'label'    => esc_html__( 'Enable tooltip', 'softim-variation-swatches' ),
				'section'  => $section_name,
				'type'     => 'checkbox',
			]
		);
		...
		$wp_customize->add_control(
			$this->settings_api->get_option_name( 'auto_button' ),
			[
				'label'    => esc_html__( 'Convert default dropdowns to buttons', 'softim-variation-swatches' ),
				'section'  => $section_name,
				'type'     => 'checkbox',
			]
		);
		...
		$wp_customize->add_control(
			$this->settings_api->get_option_name( 'show_selected_label' ),
			[
				'label'    => esc_html__( "Show the selected attribute's label", 'softim-variation-swatches' ),
				'section'  => $section_name,
				'type'     => 'checkbox',
			]
		);
