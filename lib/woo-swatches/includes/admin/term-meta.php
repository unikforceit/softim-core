...
class Term_Meta {
	...
	public function get_swatches_types() {
		return [
			'color'  => esc_html__( 'Color', 'softim-variation-swatches' ),
			'image'  => esc_html__( 'Image', 'softim-variation-swatches' ),
			'label'  => esc_html__( 'Label', 'softim-variation-swatches' ),
			'button' => esc_html__( 'Button', 'softim-variation-swatches' ),
		];
	}
	...
	public function add_attribute_fields( $taxonomy ) {
		...
		<div class="form-field term-swatches-wrap">
			...
			<p class="description"><?php esc_html_e( 'This data will be used for variation swatches of variable products.', 'softim-variation-swatches' ) ?></p>
		</div>
	...
	public function field_label( $type ) {
		$labels = [
			'color'  => esc_html__( 'Swatches Color', 'softim-variation-swatches' ),
			'image'  => esc_html__( 'Swatches Image', 'softim-variation-swatches' ),
			'label'  => esc_html__( 'Swatches Label', 'softim-variation-swatches' ),
		];
				...
				<div class="softim-variation-swatches__field-image">
					...
					<p class="hide-if-no-js">
						<a href="#"
							...
							aria-label="<?php esc_attr_e( 'Swatches Image', 'softim-variation-swatches' ) ?>"
							data-choose="<?php esc_attr_e( 'Use image', 'softim-variation-swatches' ) ?>"
						>
							<?php esc_html_e( 'Upload', 'softim-variation-swatches' ); ?>
						</a>
						<a href="#" class="button button-link button-remove-image <?php echo ! $value ? 'hidden' : '' ?>"><?php esc_html_e( 'Remove', 'softim-variation-swatches' ) ?></a>
					</p>
